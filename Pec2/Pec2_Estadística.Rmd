...
## 3.4. DespuÈs de 5 aÒos

**DespuÈs de 5 aÒos se mide de nuevo la capacidad pulmonar de las mismas personas del estudio. La columna PC5Y incorpora la capacidad pulmonar de los mismos sujetos a los 5 aÒos. Nos preguntamos si la capacidad pulmonar ha cambiado significativamente, con un nivel de confianza del 95 % en el caso de los fumadores y en el caso de los no fumadores. Responda a las siguientes preguntas**
...
### 3.4.1 Calcular si existen diferencias significativas en los no fumadores entre la capacidad pulmonar inicial y la capacidad pulmonar al cabo de 5 aÒos. Realice los pasos necesarios.

**Escribir la hipÛtesis nula y alternativa, el mÈtodo elegido y los c·lculos**

**Nota: Si define una funciÛn que realice este c·lculo, puede usarla en este apartado y en el siguiente, donde hay que repetir el mismo c·lculo para otros datos.**

#### 3.4.1.1. HipÛtesis nula y alternativa

**Escribir la hipÛtesis nula y alternativa**

* La hip√≥tesis nula  H0 es: "La capacidad pulmonar de los no fumadores no se ha visto afectada" `mu0 = 0`

* La hip√≥tesis alternativa (bilateral) es: "La capacidad pulmonar de los fumadores se ha visto afectada por el tiempo" `mu != 0` 

#### 3.4.1.2. MÈtodo

**Indicar el mÈtodo que usareis y su justificaciÛn**

En este caso se va a aplicar un contraste de hipotesis de datos aparejados, debido a que cada individuo posee dos observaciones de la misma variable. Para ello se supone, por el teorema del limite central, que estamos tratando con variables que tienen una distribuciÛn normal.
...
Los c·lculos para los fumadores son los siguientes:
...
### 3.4.2. Realizar el mismo c·lculo pero ahora por los no fumadores

El c·lculo para los no fumadores es el siguiente:
...
Para el caso de los fumadores tenemos un p-valor de 0.000, por lo tanto se debe de rechazar la hipÛtesis nula de que el valor no se ha modificado en 5 aÒos, con lo que se puede interpretar que la capacidad pulmonar cambia, se podrÌa realizar el estudio con la hipÛtesis unilateral de que el valor disminuye, sin embargo, en el enunciado se expone *Calcular si existen diferencias significativas* por lo que solo se busca la diferencia.

Por el otro lado, a la hora de compararlo con los no fumadores el p-valor es del orden de 0.3054, mayor del nivel de significaciÛn del 0.05, por lo que no se puede rechazar la hipÛtesis nula y afirmar que se encuentran cambios notables en los 5 aÒos.